    ...
    while True:
        ...
        if buffer_type in [JERRY_DEBUGGER_PARSE_ERROR,
            ...
            memory_stats = struct.unpack(debugger.byte_order + debugger.idx_format
                                    + debugger.idx_format + debugger.idx_format
                                    + debugger.idx_format + debugger.idx_format
                                    + debugger.idx_format,
                                     data[3: 3 + 4 + 4 + 4 + 4 + 4 + 4])

            print ("Allocated bytes: " + str(memory_stats[0]))
            print ("Byte code bytes: " + str(memory_stats[1]))
            print ("String bytes: " + str(memory_stats[2]))
            print ("Object bytes: " + str(memory_stats[3]))
            print ("Property bytes: " + str(memory_stats[4]))
            print ("Heap size: " + str(memory_stats[5]))
